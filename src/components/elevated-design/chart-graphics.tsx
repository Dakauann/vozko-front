...
const ChartGraphicCard: React.FC<ChartGraphicCardProps> = ({
  ...
  return (
    <motion.div
      className={cn(
        "relative flex flex-col items-center justify-end overflow-hidden rounded-[20px] bg-[rgb(245,245,245)]",
        ...
        "shadow-[inset_0px_3px_1px_0px_var(--shadow-highlight-strong)]",
        ...
        {currentHeights.map((barHeight, index) => (
          <motion.div
            ...
            style={{
              left: index * 59,
              boxShadow:
                "0px 0.71px 0.71px -0.67px rgba(0,0,0,0.08), 0px 1.81px 1.81px -1.33px rgba(0,0,0,0.08), 0px 3.62px 3.62px -2px rgba(0,0,0,0.07), 0px 6.87px 6.87px -2.67px rgba(0,0,0,0.07), 0px 13.65px 13.65px -3.33px rgba(0,0,0,0.05), 0px 30px 30px -4px rgba(0,0,0,0.02), inset 0px 3px 1px 0px var(--shadow-highlight-strong)",
            }}
