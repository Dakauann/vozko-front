    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <div className="flex h-full flex-col overflow-hidden bg-card/95 backdrop-blur-sm">
              {/* ── Header ─────────────────────────────── */}
              <div className="flex items-center justify-between border-b border-border/60 bg-card/80 backdrop-blur-sm px-5 py-3.5 flex-shrink-0">
