    ...
    >
      {featuredLabel && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
          <span className="inline-flex items-center gap-1.5 rounded-[--radius] bg-primary px-4 py-1.5 text-2xs font-semibold text-primary-foreground shadow-md">
      ...
      <div className={cn(featuredLabel && "mt-2")}>
        ...
        {!!item.plan.exclusiveAffiliateId && affiliateBrand && (
          <div className="mb-4 flex items-center gap-3 border-b border-border pb-3">
            ...
            <div className="flex min-w-0 flex-col leading-tight">
              <span className="text-2xs font-semibold tracking-[0.18em] text-muted-foreground">
                {t("exclusivePartner")}
              </span>
        ...
        <div className="flex items-start justify-between gap-2">
          ...
          {isCurrent && (
            <span className="inline-flex shrink-0 items-center gap-1 rounded-[--radius] bg-muted px-2 py-0.5 text-2xs font-semibold text-healthy-ink dark:text-healthy-ink">
