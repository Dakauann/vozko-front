...
import { ArrowDown, ArrowsLeftRight, CalendarBlank, Receipt } from "@phosphor-icons/react";
        ...
        <div className="space-y-4">
          {invoice.dueDate ? (
            <div className="flex items-center gap-2 rounded-xl border border-border/60 bg-muted/30 px-3 py-2 text-sm">
              <CalendarBlank className="h-4 w-4 text-primary" weight="bold" />
          ...
          {hasBreakdown ? (
            <div className="overflow-hidden rounded-xl border border-border/60">
              <div className="border-b border-border/50 bg-muted/30 px-3 py-2 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
                {t("detail.breakdown")}
              </div>
              ...
              <div className="flex items-center justify-between border-t border-border/50 bg-muted/20 px-3 py-2.5">
          ...
          {creditedBRL > 0 ? (
            <p className="flex items-start gap-2 rounded-xl bg-emerald-500/5 px-3 py-2.5 text-xs text-emerald-700">
