        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              {hasActiveFilters && (
                <span className="inline-flex items-center justify-center rounded-[--radius] bg-muted px-2 py-0.5 text-2xs font-semibold text-muted-foreground">
                  {activeFilterCount}
                </span>
              )}
            </div>
            {hasActiveFilters && !isExpanded ? (
              <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                <span className="text-2xs font-medium text-primary-ink">
                ...
                {activeFilterLabels.slice(0, 3).map((label, index) => (
                  <span
                    key={index}
                    className="inline-flex items-center rounded-md bg-primary px-1.5 py-0.5 text-2xs font-medium text-primary-foreground border border-primary"
                  >
                    {label}
                  </span>
                ))}
